...
(define release-notes '("Added inexact and exact numeral literals to the reader; added complex numbers to the reader.  Fixed some edge cases with modulo and quotient."))