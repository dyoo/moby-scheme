...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname bubble-2a) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define initial-w 
  (make-world (make-posn 50 50 #;(quotient WIDTH 2) #;(quotient HEIGHT 2))
              30
              (make-vel 0 0)))
