...
(define (get-default-base-pinfo) (pinfo-update-module-resolver
...
(define (compile/port in out #:name name #:pinfo (pinfo (get-default-base-pinfo)))
...
(define (compile/program a-program out 
                         #:name name 
                         #:pinfo (a-pinfo (get-default-base-pinfo)))
...
(provide/contract [compile/port ((input-port? output-port? #:name symbol?) (#:pinfo pinfo?) . ->* . any)]
                  [compile/program ((program? output-port? #:name symbol?) (#:pinfo pinfo?) . ->* . any)]
                  [get-default-base-pinfo (-> pinfo?)])