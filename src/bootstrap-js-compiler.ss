...
(define RUNTIME-MODULE-PATHS
  (list (build-path RUNTIME-SRC-PATH "stx.ss")
        (build-path RUNTIME-SRC-PATH "permission-struct.ss")
        (build-path RUNTIME-SRC-PATH "effect-struct.ss")
        (build-path RUNTIME-SRC-PATH "arity-struct.ss")
        (build-path RUNTIME-SRC-PATH "error-struct.ss")))
...
(define (write-runtime-toplevel-bindings-descriptions)
  (call-with-output-file "compiler/gen/runtime-modules.ss"
    (lambda (op)
      ...
      (fprintf op ";; This file is automagically generated and maintained by bootstrap-js-compiler.  Do not edit this file by hand.\n")
      (pretty-print 
               `(define MOBY-RUNTIME-MODULE-BINDINGS
                  (list ,@
                  (for/list ([a-path (in-list RUNTIME-MODULE-PATHS)])
