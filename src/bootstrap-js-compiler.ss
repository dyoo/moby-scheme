...
(define RUNTIME-MODULES
  (list (make-module-record 'moby/runtime/stx 
...
(define (write-runtime-toplevel-bindings-descriptions)
  ...
  (let ([moby-runtime-module-bindings-description
    ...
    (call-with-output-file "collects/runtime-modules.ss"
      (lambda (op)
        (fprintf op "#lang s-exp \"runtime/private/restricted-runtime-scheme.ss\"\n")
