...
function env_dash_keys(an_dash_env) { return (org.plt.Kernel._kernelHashMap((env_dash_bindings(an_dash_env)),(function(args102391) { var k = args102391[0];
var v = args102391[1];
                             return k; }))); }
...
function program_question_(datum) { return (((list_question_(datum)))&&((org.plt.Kernel.andmap((function(args102392) { var x = args102392[0];
...
function pinfo_dash_used_dash_bindings(a_dash_pinfo) { return (org.plt.Kernel._kernelHashMap((pinfo_dash_used_dash_bindings_dash_hash(a_dash_pinfo)),(function(args102396) { var k = args102396[0];
var v = args102396[1];
                             return v; }))); }
...
pinfo_dash_1 = (program_dash_analyze_dash_collect_dash_definitions(a_dash_program,pinfo));
...
function definition_dash_analyze_dash_collect_dash_definitions(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args102397) { var id = args102397[0];
var args = args102397[1];
var body = args102397[2];
                             return (pinfo_dash_accumulate_dash_binding((bf(id,org.plt.types.Logic.FALSE,(org.plt.Kernel.length(args)),org.plt.types.Logic.FALSE,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))))),pinfo)); }),(function(args102398) { var id = args102398[0];
var expr = args102398[1];
                             return (pinfo_dash_accumulate_dash_binding((make_dash_binding_colon_constant(id,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),org.plt.types.Empty.EMPTY)),pinfo)); }),(function(args102399) { var id = args102399[0];
var fields = args102399[1];
...
constructor_dash_id = (org.plt.Kernel.string_dash__greaterthan_symbol(org.plt.Kernel.format((org.plt.types.String.makeInstance("make-~a")), [id])));
...
selector_dash_ids = org.plt.Kernel.map((function(args102400) { var f = args102400[0];
                             return (org.plt.Kernel.string_dash__greaterthan_symbol(org.plt.Kernel.format((org.plt.types.String.makeInstance("~a-~a")), [id,f]))); }), [fields]);
selector_dash_bindings = org.plt.Kernel.map((function(args102401) { var sel_dash_id = args102401[0];
               ...
               return (org.plt.Kernel.foldl((function(args102402) { var a_dash_binding = args102402[0];
var an_dash_env = args102402[1];
...
function definition_dash_analyze_dash_uses(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args102403) { var id = args102403[0];
var args = args102403[1];
var body = args102403[2];
                             return (function_dash_definition_dash_analyze_dash_uses(id,args,body,pinfo)); }),(function(args102404) { var id = args102404[0];
var expr = args102404[1];
                             return (expression_dash_analyze_dash_uses(expr,pinfo,(pinfo_dash_env(pinfo)))); }),(function(args102405) { var id = args102405[0];
var fields = args102405[1];
                             return pinfo; }))); }
...
env_dash_1 = (pinfo_dash_env(pinfo));
env_dash_2 = (org.plt.Kernel.foldl((function(args102406) { var arg_dash_id = args102406[0];
var env = args102406[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return (org.plt.Kernel.foldl((function(args102407) { var e = args102407[0];
var p = args102407[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return (org.plt.Kernel.foldl((function(args102408) { var e = args102408[0];
var p = args102408[1];
                             return (expression_dash_analyze_dash_uses(e,p,env)); }),pinfo,exprs));
...
body = (org.plt.Kernel.third(an_dash_expression));
nested_dash_pinfo = (org.plt.Kernel.foldl((function(args102409) { var a_dash_defn = args102409[0];
var a_dash_pinfo = args102409[1];
...
alternative = (org.plt.Kernel.fourth(an_dash_expression));
               return (org.plt.Kernel.foldl((function(args102410) { var e = args102410[0];
var p = args102410[1];
...
updated_dash_pinfo = (org.plt.Kernel.foldl((function(args102411) { var e = args102411[0];
var p = args102411[1];
...
defn_dash_string_plus_expr_dash_string = (definition_dash__greaterthan_javascript_dash_strings((org.plt.Kernel.first(program)),toplevel_dash_env,a_dash_pinfo));
...
function definition_dash__greaterthan_javascript_dash_strings(defn, env, a_dash_pinfo) { return (case_dash_analyze_dash_definition(defn,(function(args102412) { var fun = args102412[0];
var args = args102412[1];
var body = args102412[2];
                             return org.plt.Kernel.list([(function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)),(org.plt.types.String.makeInstance(""))]); }),(function(args102413) { var id = args102413[0];
var body = args102413[1];
                             return (variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); }),(function(args102414) { var id = args102414[0];
var fields = args102414[1];
...
env_dash_with_dash_arg_dash_bindings = (org.plt.Kernel.foldl((function(args102415) { var arg_dash_id = args102415[0];
var env = args102415[1];
               ...
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(org.plt.Kernel.symbol_dash__greaterthan_string(munged_dash_fun_dash_id)),(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args102416) { var arg_dash_id = args102416[0];
...
make_dash_id = (org.plt.Kernel.string_dash__greaterthan_symbol(org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("make-")),(org.plt.Kernel.symbol_dash__greaterthan_string(id))])));
              ...
              })(),(org.plt.types.String.makeInstance("(")),(string_dash_join((org.plt.Kernel.build_dash_list((org.plt.Kernel.length(fields)),(function(args102420) { var i = args102420[0];
                             return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("id")),(org.plt.Kernel.number_dash__greaterthan_string(i))]); }))),(org.plt.types.String.makeInstance(",")))),(org.plt.types.String.makeInstance(") { return new ")),(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),(org.plt.types.String.makeInstance("(")),(string_dash_join((org.plt.Kernel.build_dash_list((org.plt.Kernel.length(fields)),(function(args102421) { var i = args102421[0];
                             return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("id")),(org.plt.Kernel.number_dash__greaterthan_string(i))]); }))),(org.plt.types.String.makeInstance(",")))),(org.plt.types.String.makeInstance("); }"))]),(org.plt.types.String.makeInstance("\n")),(string_dash_join(org.plt.Kernel.map((function(args102422) { var a_dash_field = args102422[0];
                             return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(function() {
                     // Local
               
var acc_dash_id; 
               
acc_dash_id = (org.plt.Kernel.string_dash__greaterthan_symbol(org.plt.Kernel.string_dash_append([(org.plt.Kernel.symbol_dash__greaterthan_string(id)),(org.plt.types.String.makeInstance("-")),(org.plt.Kernel.symbol_dash__greaterthan_string(a_dash_field))])));
...
exprs = (org.plt.Kernel.rest(expr));
...
function boolean_dash_chain_dash__greaterthan_javascript_dash_string(joiner, exprs, env, a_dash_pinfo) { return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args102423) { var e = args102423[0];
...
inner_dash_compiled_dash_program = (_dash_program_dash__greaterthan_compiled_dash_program(defns,(pinfo_dash_update_dash_env(a_dash_pinfo,env))));
inner_dash_body_dash_string = (expression_dash__greaterthan_javascript_dash_string(body,(pinfo_dash_env((compiled_dash_program_dash_pinfo(inner_dash_compiled_dash_program)))),(compiled_dash_program_dash_pinfo(inner_dash_compiled_dash_program))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function() {\n                     // Local\n               ")),(compiled_dash_program_dash_defns(inner_dash_compiled_dash_program)),(org.plt.types.String.makeInstance("\n               ")),(compiled_dash_program_dash_toplevel_dash_exprs(inner_dash_compiled_dash_program)),(org.plt.types.String.makeInstance("\n               return ")),inner_dash_body_dash_string,(org.plt.types.String.makeInstance(";\n              })()"))]);
              })(); }
...
operand_dash_strings = org.plt.Kernel.map((function(args102424) { var e = args102424[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args102425) { var e = args102425[0];
                             return (expression_dash__greaterthan_javascript_dash_string(e,env,a_dash_pinfo)); }), [operands]);
...
new_dash_env = (org.plt.Kernel.foldl((function(args102427) { var arg_dash_id = args102427[0];
var env = args102427[1];
...
args_dash_sym = (make_dash_args_dash_symbol((org.plt.types.Symbol.makeInstance("lambda-expression->javascript-string"))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function(")),(org.plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(org.plt.types.String.makeInstance(") { ")),(string_dash_join((mapi((function(args102428) { var arg_dash_id = args102428[0];
var i = args102428[1];
...
top_dash_env_dash_1 = (org.plt.Kernel.foldl((function(args102393) { var id_plus_name = args102393[0];
var env = args102393[1];
...
top_dash_env_dash_2 = (org.plt.Kernel.foldl((function(args102394) { var name_plus_arity = args102394[0];
var env = args102394[1];
...
top_dash_env_dash_3 = (org.plt.Kernel.foldl((function(args102395) { var id_plus_arity_plus_name = args102395[0];
var env = args102395[1];
...
module_dash_path = (org.plt.Kernel._resolveModulePath((org.plt.Kernel.cons((org.plt.types.Symbol.makeInstance("lib")), (org.plt.Kernel.cons((org.plt.types.String.makeInstance("gui-world.ss")), (org.plt.Kernel.cons((org.plt.types.String.makeInstance("gui-world")), org.plt.types.Empty.EMPTY)))))),org.plt.types.Logic.FALSE));
