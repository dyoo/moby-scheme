...
function env_dash_keys(an_dash_env) { return (org.plt.Kernel._kernelHashMap((env_dash_bindings(an_dash_env)),(function(args3687) { var k = args3687[0];
var v = args3687[1];
                             return k; }))); }
...
function program_question_(datum) { return (((list_question_(datum)))&&((org.plt.Kernel.andmap((function(args3688) { var x = args3688[0];
...
function pinfo_dash_used_dash_bindings(a_dash_pinfo) { return (org.plt.Kernel._kernelHashMap((pinfo_dash_used_dash_bindings_dash_hash(a_dash_pinfo)),(function(args3692) { var k = args3692[0];
var v = args3692[1];
                             return v; }))); }
...
function definition_dash_analyze_dash_collect_dash_definitions(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args3693) { var id = args3693[0];
var args = args3693[1];
var body = args3693[2];
                             return (pinfo_dash_accumulate_dash_binding((bf(id,org.plt.types.Logic.FALSE,(org.plt.Kernel.length(args)),org.plt.types.Logic.FALSE,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))))),pinfo)); }),(function(args3694) { var id = args3694[0];
var expr = args3694[1];
                             return (pinfo_dash_accumulate_dash_binding((make_dash_binding_colon_constant(id,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),org.plt.types.Empty.EMPTY)),pinfo)); }),(function(args3695) { var id = args3695[0];
var fields = args3695[1];
...
selector_dash_ids = org.plt.Kernel.map((function(args3696) { var f = args3696[0];
...
selector_dash_bindings = org.plt.Kernel.map((function(args3697) { var sel_dash_id = args3697[0];
               ...
               return org.plt.Kernel.foldl((function(args3698) { var a_dash_binding = args3698[0];
var an_dash_env = args3698[1];
...
function definition_dash_analyze_dash_uses(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args3699) { var id = args3699[0];
var args = args3699[1];
var body = args3699[2];
                             return (function_dash_definition_dash_analyze_dash_uses(id,args,body,pinfo)); }),(function(args3700) { var id = args3700[0];
var expr = args3700[1];
                             return (expression_dash_analyze_dash_uses(expr,pinfo,(pinfo_dash_env(pinfo)))); }),(function(args3701) { var id = args3701[0];
var fields = args3701[1];
                             return pinfo; }))); }
...
env_dash_1 = (pinfo_dash_env(pinfo));
env_dash_2 = org.plt.Kernel.foldl((function(args3702) { var arg_dash_id = args3702[0];
var env = args3702[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args3703) { var e = args3703[0];
var p = args3703[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args3704) { var e = args3704[0];
var p = args3704[1];
                             return (expression_dash_analyze_dash_uses(e,p,env)); }),pinfo, [exprs]);
...
body = (org.plt.Kernel.third(an_dash_expression));
nested_dash_pinfo = org.plt.Kernel.foldl((function(args3705) { var a_dash_defn = args3705[0];
var a_dash_pinfo = args3705[1];
...
alternative = (org.plt.Kernel.fourth(an_dash_expression));
               return org.plt.Kernel.foldl((function(args3706) { var e = args3706[0];
var p = args3706[1];
...
updated_dash_pinfo = org.plt.Kernel.foldl((function(args3707) { var e = args3707[0];
var p = args3707[1];
...
function definition_dash__greaterthan_javascript_dash_strings(defn, env, a_dash_pinfo) { return (case_dash_analyze_dash_definition(defn,(function(args3708) { var fun = args3708[0];
var args = args3708[1];
var body = args3708[2];
                             return org.plt.Kernel.list([(function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)),(org.plt.types.String.makeInstance(""))]); }),(function(args3709) { var id = args3709[0];
var body = args3709[1];
                             return (variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); }),(function(args3710) { var id = args3710[0];
var fields = args3710[1];
...
env_dash_with_dash_arg_dash_bindings = org.plt.Kernel.foldl((function(args3711) { var arg_dash_id = args3711[0];
var env = args3711[1];
               ...
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(org.plt.Kernel.symbol_dash__greaterthan_string(munged_dash_fun_dash_id)),(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args3712) { var arg_dash_id = args3712[0];
...
function boolean_dash_chain_dash__greaterthan_javascript_dash_string(joiner, exprs, env, a_dash_pinfo) { return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args3719) { var e = args3719[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args3720) { var e = args3720[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args3721) { var e = args3721[0];
                             return (expression_dash__greaterthan_javascript_dash_string(e,env,a_dash_pinfo)); }), [operands]);
...
new_dash_env = org.plt.Kernel.foldl((function(args3723) { var arg_dash_id = args3723[0];
var env = args3723[1];
...
args_dash_sym = (make_dash_args_dash_symbol((org.plt.types.Symbol.makeInstance("lambda-expression->javascript-string"))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function(")),(org.plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(org.plt.types.String.makeInstance(") { ")),(string_dash_join((mapi((function(args3724) { var arg_dash_id = args3724[0];
var i = args3724[1];
...
top_dash_env_dash_1 = org.plt.Kernel.foldl((function(args3689) { var id_plus_name = args3689[0];
var env = args3689[1];
...
top_dash_env_dash_2 = org.plt.Kernel.foldl((function(args3690) { var name_plus_arity = args3690[0];
var env = args3690[1];
...
top_dash_env_dash_3 = org.plt.Kernel.foldl((function(args3691) { var id_plus_arity_plus_name = args3691[0];
var env = args3691[1];
