...
function env_dash_keys(an_dash_env) { return (org.plt.Kernel._kernelHashMap((env_dash_bindings(an_dash_env)),(function(args6669) { var k = args6669[0];
var v = args6669[1];
                             return k; }))); }
...
function program_question_(datum) { return (((list_question_(datum)))&&((org.plt.Kernel.andmap((function(args6670) { var x = args6670[0];
...
function pinfo_dash_used_dash_bindings(a_dash_pinfo) { return (org.plt.Kernel._kernelHashMap((pinfo_dash_used_dash_bindings_dash_hash(a_dash_pinfo)),(function(args6674) { var k = args6674[0];
var v = args6674[1];
                             return v; }))); }
...
function definition_dash_analyze_dash_collect_dash_definitions(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args6675) { var id = args6675[0];
var args = args6675[1];
var body = args6675[2];
                             return (pinfo_dash_accumulate_dash_binding((bf(id,org.plt.types.Logic.FALSE,(org.plt.Kernel.length(args)),org.plt.types.Logic.FALSE,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))))),pinfo)); }),(function(args6676) { var id = args6676[0];
var expr = args6676[1];
                             return (pinfo_dash_accumulate_dash_binding((make_dash_binding_colon_constant(id,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),org.plt.types.Empty.EMPTY)),pinfo)); }),(function(args6677) { var id = args6677[0];
var fields = args6677[1];
...
selector_dash_ids = org.plt.Kernel.map((function(args6678) { var f = args6678[0];
...
selector_dash_bindings = org.plt.Kernel.map((function(args6679) { var sel_dash_id = args6679[0];
               ...
               return org.plt.Kernel.foldl((function(args6680) { var a_dash_binding = args6680[0];
var an_dash_env = args6680[1];
...
function definition_dash_analyze_dash_uses(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args6681) { var id = args6681[0];
var args = args6681[1];
var body = args6681[2];
                             return (function_dash_definition_dash_analyze_dash_uses(id,args,body,pinfo)); }),(function(args6682) { var id = args6682[0];
var expr = args6682[1];
                             return (expression_dash_analyze_dash_uses(expr,pinfo,(pinfo_dash_env(pinfo)))); }),(function(args6683) { var id = args6683[0];
var fields = args6683[1];
                             return pinfo; }))); }
...
env_dash_1 = (pinfo_dash_env(pinfo));
env_dash_2 = org.plt.Kernel.foldl((function(args6684) { var arg_dash_id = args6684[0];
var env = args6684[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args6685) { var e = args6685[0];
var p = args6685[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args6686) { var e = args6686[0];
var p = args6686[1];
                             return (expression_dash_analyze_dash_uses(e,p,env)); }),pinfo, [exprs]);
...
body = (org.plt.Kernel.third(an_dash_expression));
nested_dash_pinfo = org.plt.Kernel.foldl((function(args6687) { var a_dash_defn = args6687[0];
var a_dash_pinfo = args6687[1];
...
alternative = (org.plt.Kernel.fourth(an_dash_expression));
               return org.plt.Kernel.foldl((function(args6688) { var e = args6688[0];
var p = args6688[1];
...
updated_dash_pinfo = org.plt.Kernel.foldl((function(args6689) { var e = args6689[0];
var p = args6689[1];
...
function definition_dash__greaterthan_javascript_dash_strings(defn, env, a_dash_pinfo) { return (case_dash_analyze_dash_definition(defn,(function(args6690) { var fun = args6690[0];
var args = args6690[1];
var body = args6690[2];
                             return org.plt.Kernel.list([(function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)),(org.plt.types.String.makeInstance(""))]); }),(function(args6691) { var id = args6691[0];
var body = args6691[1];
                             return (variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); }),(function(args6692) { var id = args6692[0];
var fields = args6692[1];
...
env_dash_with_dash_arg_dash_bindings = org.plt.Kernel.foldl((function(args6693) { var arg_dash_id = args6693[0];
var env = args6693[1];
               ...
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(org.plt.Kernel.symbol_dash__greaterthan_string(munged_dash_fun_dash_id)),(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args6694) { var arg_dash_id = args6694[0];
...
function boolean_dash_chain_dash__greaterthan_javascript_dash_string(joiner, exprs, env, a_dash_pinfo) { return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args6701) { var e = args6701[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args6702) { var e = args6702[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args6703) { var e = args6703[0];
                             return (expression_dash__greaterthan_javascript_dash_string(e,env,a_dash_pinfo)); }), [operands]);
...
new_dash_env = org.plt.Kernel.foldl((function(args6705) { var arg_dash_id = args6705[0];
var env = args6705[1];
...
args_dash_sym = (make_dash_args_dash_symbol((org.plt.types.Symbol.makeInstance("lambda-expression->javascript-string"))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function(")),(org.plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(org.plt.types.String.makeInstance(") { ")),(string_dash_join((mapi((function(args6706) { var arg_dash_id = args6706[0];
var i = args6706[1];
...
top_dash_env_dash_1 = org.plt.Kernel.foldl((function(args6671) { var id_plus_name = args6671[0];
var env = args6671[1];
...
top_dash_env_dash_2 = org.plt.Kernel.foldl((function(args6672) { var name_plus_arity = args6672[0];
var env = args6672[1];
...
top_dash_env_dash_3 = org.plt.Kernel.foldl((function(args6673) { var id_plus_arity_plus_name = args6673[0];
var env = args6673[1];
