...
function env_dash_keys(an_dash_env) { return (org.plt.Kernel._kernelHashMap((env_dash_bindings(an_dash_env)),(function(args12272) { var k = args12272[0];
var v = args12272[1];
                             return k; }))); }
...
function program_question_(datum) { return (((list_question_(datum)))&&((org.plt.Kernel.andmap((function(args12273) { var x = args12273[0];
...
function pinfo_dash_used_dash_bindings(a_dash_pinfo) { return (org.plt.Kernel._kernelHashMap((pinfo_dash_used_dash_bindings_dash_hash(a_dash_pinfo)),(function(args12277) { var k = args12277[0];
var v = args12277[1];
                             return v; }))); }
...
function definition_dash_analyze_dash_collect_dash_definitions(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args12278) { var id = args12278[0];
var args = args12278[1];
var body = args12278[2];
                             return (pinfo_dash_accumulate_dash_binding((bf(id,org.plt.types.Logic.FALSE,(org.plt.Kernel.length(args)),org.plt.types.Logic.FALSE,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))))),pinfo)); }),(function(args12279) { var id = args12279[0];
var expr = args12279[1];
                             return (pinfo_dash_accumulate_dash_binding((make_dash_binding_colon_constant(id,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),org.plt.types.Empty.EMPTY)),pinfo)); }),(function(args12280) { var id = args12280[0];
var fields = args12280[1];
...
selector_dash_ids = org.plt.Kernel.map((function(args12281) { var f = args12281[0];
...
selector_dash_bindings = org.plt.Kernel.map((function(args12282) { var sel_dash_id = args12282[0];
               ...
               return org.plt.Kernel.foldl((function(args12283) { var a_dash_binding = args12283[0];
var an_dash_env = args12283[1];
...
function definition_dash_analyze_dash_uses(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args12284) { var id = args12284[0];
var args = args12284[1];
var body = args12284[2];
                             return (function_dash_definition_dash_analyze_dash_uses(id,args,body,pinfo)); }),(function(args12285) { var id = args12285[0];
var expr = args12285[1];
                             return (expression_dash_analyze_dash_uses(expr,pinfo,(pinfo_dash_env(pinfo)))); }),(function(args12286) { var id = args12286[0];
var fields = args12286[1];
                             return pinfo; }))); }
...
env_dash_1 = (pinfo_dash_env(pinfo));
env_dash_2 = org.plt.Kernel.foldl((function(args12287) { var arg_dash_id = args12287[0];
var env = args12287[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args12288) { var e = args12288[0];
var p = args12288[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args12289) { var e = args12289[0];
var p = args12289[1];
                             return (expression_dash_analyze_dash_uses(e,p,env)); }),pinfo, [exprs]);
...
body = (org.plt.Kernel.third(an_dash_expression));
nested_dash_pinfo = org.plt.Kernel.foldl((function(args12290) { var a_dash_defn = args12290[0];
var a_dash_pinfo = args12290[1];
...
alternative = (org.plt.Kernel.fourth(an_dash_expression));
               return org.plt.Kernel.foldl((function(args12291) { var e = args12291[0];
var p = args12291[1];
...
updated_dash_pinfo = org.plt.Kernel.foldl((function(args12292) { var e = args12292[0];
var p = args12292[1];
...
function definition_dash__greaterthan_javascript_dash_strings(defn, env, a_dash_pinfo) { return (case_dash_analyze_dash_definition(defn,(function(args12293) { var fun = args12293[0];
var args = args12293[1];
var body = args12293[2];
                             return org.plt.Kernel.list([(function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)),(org.plt.types.String.makeInstance(""))]); }),(function(args12294) { var id = args12294[0];
var body = args12294[1];
                             return (variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); }),(function(args12295) { var id = args12295[0];
var fields = args12295[1];
...
env_dash_with_dash_arg_dash_bindings = org.plt.Kernel.foldl((function(args12296) { var arg_dash_id = args12296[0];
var env = args12296[1];
               ...
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(org.plt.Kernel.symbol_dash__greaterthan_string(munged_dash_fun_dash_id)),(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args12297) { var arg_dash_id = args12297[0];
...
function boolean_dash_chain_dash__greaterthan_javascript_dash_string(joiner, exprs, env, a_dash_pinfo) { return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args12304) { var e = args12304[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args12305) { var e = args12305[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args12306) { var e = args12306[0];
                             return (expression_dash__greaterthan_javascript_dash_string(e,env,a_dash_pinfo)); }), [operands]);
...
new_dash_env = org.plt.Kernel.foldl((function(args12308) { var arg_dash_id = args12308[0];
var env = args12308[1];
...
args_dash_sym = (make_dash_args_dash_symbol((org.plt.types.Symbol.makeInstance("lambda-expression->javascript-string"))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function(")),(org.plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(org.plt.types.String.makeInstance(") { ")),(string_dash_join((mapi((function(args12309) { var arg_dash_id = args12309[0];
var i = args12309[1];
...
top_dash_env_dash_1 = org.plt.Kernel.foldl((function(args12274) { var id_plus_name = args12274[0];
var env = args12274[1];
...
top_dash_env_dash_2 = org.plt.Kernel.foldl((function(args12275) { var name_plus_arity = args12275[0];
var env = args12275[1];
...
top_dash_env_dash_3 = org.plt.Kernel.foldl((function(args12276) { var id_plus_arity_plus_name = args12276[0];
var env = args12276[1];
