...
function env_dash_keys(an_dash_env) { return (org.plt.Kernel._kernelHashMap((env_dash_bindings(an_dash_env)),(function(args3077) { var k = args3077[0];
var v = args3077[1];
                             return k; }))); }
...
function program_question_(datum) { return (((list_question_(datum)))&&((org.plt.Kernel.andmap((function(args3078) { var x = args3078[0];
...
function pinfo_dash_used_dash_bindings(a_dash_pinfo) { return (org.plt.Kernel._kernelHashMap((pinfo_dash_used_dash_bindings_dash_hash(a_dash_pinfo)),(function(args3082) { var k = args3082[0];
var v = args3082[1];
                             return v; }))); }
...
function definition_dash_analyze_dash_collect_dash_definitions(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args3083) { var id = args3083[0];
var args = args3083[1];
var body = args3083[2];
                             return (pinfo_dash_accumulate_dash_binding((bf(id,org.plt.types.Logic.FALSE,(org.plt.Kernel.length(args)),org.plt.types.Logic.FALSE,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))))),pinfo)); }),(function(args3084) { var id = args3084[0];
var expr = args3084[1];
                             return (pinfo_dash_accumulate_dash_binding((make_dash_binding_colon_constant(id,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),org.plt.types.Empty.EMPTY)),pinfo)); }),(function(args3085) { var id = args3085[0];
var fields = args3085[1];
...
selector_dash_ids = org.plt.Kernel.map((function(args3086) { var f = args3086[0];
...
selector_dash_bindings = org.plt.Kernel.map((function(args3087) { var sel_dash_id = args3087[0];
               ...
               return org.plt.Kernel.foldl((function(args3088) { var a_dash_binding = args3088[0];
var an_dash_env = args3088[1];
...
function definition_dash_analyze_dash_uses(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args3089) { var id = args3089[0];
var args = args3089[1];
var body = args3089[2];
                             return (function_dash_definition_dash_analyze_dash_uses(id,args,body,pinfo)); }),(function(args3090) { var id = args3090[0];
var expr = args3090[1];
                             return (expression_dash_analyze_dash_uses(expr,pinfo,(pinfo_dash_env(pinfo)))); }),(function(args3091) { var id = args3091[0];
var fields = args3091[1];
                             return pinfo; }))); }
...
env_dash_1 = (pinfo_dash_env(pinfo));
env_dash_2 = org.plt.Kernel.foldl((function(args3092) { var arg_dash_id = args3092[0];
var env = args3092[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args3093) { var e = args3093[0];
var p = args3093[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args3094) { var e = args3094[0];
var p = args3094[1];
                             return (expression_dash_analyze_dash_uses(e,p,env)); }),pinfo, [exprs]);
...
body = (org.plt.Kernel.third(an_dash_expression));
nested_dash_pinfo = org.plt.Kernel.foldl((function(args3095) { var a_dash_defn = args3095[0];
var a_dash_pinfo = args3095[1];
...
alternative = (org.plt.Kernel.fourth(an_dash_expression));
               return org.plt.Kernel.foldl((function(args3096) { var e = args3096[0];
var p = args3096[1];
...
updated_dash_pinfo = org.plt.Kernel.foldl((function(args3097) { var e = args3097[0];
var p = args3097[1];
...
function definition_dash__greaterthan_javascript_dash_strings(defn, env, a_dash_pinfo) { return (case_dash_analyze_dash_definition(defn,(function(args3098) { var fun = args3098[0];
var args = args3098[1];
var body = args3098[2];
                             return org.plt.Kernel.list([(function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)),(org.plt.types.String.makeInstance(""))]); }),(function(args3099) { var id = args3099[0];
var body = args3099[1];
                             return (variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); }),(function(args3100) { var id = args3100[0];
var fields = args3100[1];
...
env_dash_with_dash_arg_dash_bindings = org.plt.Kernel.foldl((function(args3101) { var arg_dash_id = args3101[0];
var env = args3101[1];
               ...
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(org.plt.Kernel.symbol_dash__greaterthan_string(munged_dash_fun_dash_id)),(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args3102) { var arg_dash_id = args3102[0];
...
function boolean_dash_chain_dash__greaterthan_javascript_dash_string(joiner, exprs, env, a_dash_pinfo) { return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args3109) { var e = args3109[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args3110) { var e = args3110[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args3111) { var e = args3111[0];
                             return (expression_dash__greaterthan_javascript_dash_string(e,env,a_dash_pinfo)); }), [operands]);
...
new_dash_env = org.plt.Kernel.foldl((function(args3113) { var arg_dash_id = args3113[0];
var env = args3113[1];
...
args_dash_sym = (make_dash_args_dash_symbol((org.plt.types.Symbol.makeInstance("lambda-expression->javascript-string"))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function(")),(org.plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(org.plt.types.String.makeInstance(") { ")),(string_dash_join((mapi((function(args3114) { var arg_dash_id = args3114[0];
var i = args3114[1];
...
top_dash_env_dash_1 = org.plt.Kernel.foldl((function(args3079) { var id_plus_name = args3079[0];
var env = args3079[1];
...
top_dash_env_dash_2 = org.plt.Kernel.foldl((function(args3080) { var name_plus_arity = args3080[0];
var env = args3080[1];
...
top_dash_env_dash_3 = org.plt.Kernel.foldl((function(args3081) { var id_plus_arity_plus_name = args3081[0];
var env = args3081[1];
