...
function pinfo_dash_used_dash_bindings(a_dash_pinfo) { return (org.plt.Kernel._kernelHashMap((pinfo_dash_used_dash_bindings_dash_hash(a_dash_pinfo)),(function(args6) { var k = args6[0];
var v = args6[1];
                             return v; }))); }
...
function definition_dash_analyze_dash_collect_dash_definitions(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args7) { var id = args7[0];
var args = args7[1];
var body = args7[2];
                             return (pinfo_dash_accumulate_dash_binding((bf(id,org.plt.types.Logic.FALSE,(org.plt.Kernel.length(args)),org.plt.types.Logic.FALSE,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))))),pinfo)); }),(function(args8) { var id = args8[0];
var expr = args8[1];
                             return (pinfo_dash_accumulate_dash_binding((make_dash_binding_colon_constant(id,(org.plt.Kernel.symbol_dash__greaterthan_string((identifier_dash__greaterthan_munged_dash_java_dash_identifier(id)))),org.plt.types.Empty.EMPTY)),pinfo)); }),(function(args9) { var id = args9[0];
var fields = args9[1];
...
selector_dash_ids = org.plt.Kernel.map((function(args10) { var f = args10[0];
...
selector_dash_bindings = org.plt.Kernel.map((function(args11) { var sel_dash_id = args11[0];
               ...
               return org.plt.Kernel.foldl((function(args12) { var a_dash_binding = args12[0];
var an_dash_env = args12[1];
...
function definition_dash_analyze_dash_uses(a_dash_definition, pinfo) { return (case_dash_analyze_dash_definition(a_dash_definition,(function(args13) { var id = args13[0];
var args = args13[1];
var body = args13[2];
                             return (function_dash_definition_dash_analyze_dash_uses(id,args,body,pinfo)); }),(function(args14) { var id = args14[0];
var expr = args14[1];
                             return (expression_dash_analyze_dash_uses(expr,pinfo,(pinfo_dash_env(pinfo)))); }),(function(args15) { var id = args15[0];
var fields = args15[1];
                             return pinfo; }))); }
...
env_dash_1 = (pinfo_dash_env(pinfo));
env_dash_2 = org.plt.Kernel.foldl((function(args16) { var arg_dash_id = args16[0];
var env = args16[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args17) { var e = args17[0];
var p = args17[1];
...
exprs = (org.plt.Kernel.rest(an_dash_expression));
               return org.plt.Kernel.foldl((function(args18) { var e = args18[0];
var p = args18[1];
                             return (expression_dash_analyze_dash_uses(e,p,env)); }),pinfo, [exprs]);
...
body = (org.plt.Kernel.third(an_dash_expression));
nested_dash_pinfo = org.plt.Kernel.foldl((function(args19) { var a_dash_defn = args19[0];
var a_dash_pinfo = args19[1];
...
alternative = (org.plt.Kernel.fourth(an_dash_expression));
               return org.plt.Kernel.foldl((function(args20) { var e = args20[0];
var p = args20[1];
...
updated_dash_pinfo = org.plt.Kernel.foldl((function(args21) { var e = args21[0];
var p = args21[1];
...
function definition_dash__greaterthan_javascript_dash_strings(defn, env, a_dash_pinfo) { return (case_dash_analyze_dash_definition(defn,(function(args22) { var fun = args22[0];
var args = args22[1];
var body = args22[2];
                             return org.plt.Kernel.list([(function_dash_definition_dash__greaterthan_java_dash_string(fun,args,body,env,a_dash_pinfo)),(org.plt.types.String.makeInstance(""))]); }),(function(args23) { var id = args23[0];
var body = args23[1];
                             return (variable_dash_definition_dash__greaterthan_javascript_dash_strings(id,body,env,a_dash_pinfo)); }),(function(args24) { var id = args24[0];
var fields = args24[1];
...
env_dash_with_dash_arg_dash_bindings = org.plt.Kernel.foldl((function(args25) { var arg_dash_id = args25[0];
var env = args25[1];
               ...
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("function ")),(org.plt.Kernel.symbol_dash__greaterthan_string(munged_dash_fun_dash_id)),(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args26) { var arg_dash_id = args26[0];
...
function boolean_dash_chain_dash__greaterthan_javascript_dash_string(joiner, exprs, env, a_dash_pinfo) { return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(")),(string_dash_join(org.plt.Kernel.map((function(args33) { var e = args33[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args34) { var e = args34[0];
...
operand_dash_strings = org.plt.Kernel.map((function(args35) { var e = args35[0];
                             return (expression_dash__greaterthan_javascript_dash_string(e,env,a_dash_pinfo)); }), [operands]);
...
new_dash_env = org.plt.Kernel.foldl((function(args37) { var arg_dash_id = args37[0];
var env = args37[1];
...
args_dash_sym = (make_dash_args_dash_symbol((org.plt.types.Symbol.makeInstance("lambda-expression->javascript-string"))));
               return org.plt.Kernel.string_dash_append([(org.plt.types.String.makeInstance("(function(")),(org.plt.Kernel.symbol_dash__greaterthan_string(args_dash_sym)),(org.plt.types.String.makeInstance(") { ")),(string_dash_join((mapi((function(args38) { var arg_dash_id = args38[0];
var i = args38[1];
...
top_dash_env_dash_1 = org.plt.Kernel.foldl((function(args3) { var id_plus_name = args3[0];
var env = args3[1];
...
top_dash_env_dash_2 = org.plt.Kernel.foldl((function(args4) { var name_plus_arity = args4[0];
var env = args4[1];
...
top_dash_env_dash_3 = org.plt.Kernel.foldl((function(args5) { var id_plus_arity_plus_name = args5[0];
var env = args5[1];
