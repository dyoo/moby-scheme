...
var desugar_dash_expression = function(expr, pinfo) { return ((plt.Kernel.setLastLoc("offset=7235 line=141 span=29 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("cond")))) ?
 ...
 (function(){(plt.Kernel.setLastLoc("offset=8500 line=169 span=56 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=8524 line=169 span=26 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=8530 line=169 span=19 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=8536 line=169 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))))),expr));
return ((function() { 
...
local_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=8607 line=170 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=8614 line=170 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
defns = (plt.Kernel.setLastLoc("offset=8668 line=171 span=29 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=8675 line=171 span=21 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=8683 line=171 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))))));
body = (plt.Kernel.setLastLoc("offset=8737 line=172 span=20 id=\"desugar.ss\"")   && plt.Kernel.third((plt.Kernel.setLastLoc("offset=8744 line=172 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_defns_plus_pinfo = (plt.Kernel.setLastLoc("offset=8840 line=174 span=29 id=\"desugar.ss\"")   && desugar_dash_program(defns,pinfo));
desugared_dash_body_plus_pinfo = (plt.Kernel.setLastLoc("offset=8925 line=175 span=56 id=\"desugar.ss\"")   && desugar_dash_expression(body,(plt.Kernel.setLastLoc("offset=8950 line=175 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_defns_plus_pinfo)))); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=9003 line=176 span=496 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=9009 line=176 span=354 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=9024 line=176 span=283 id=\"desugar.ss\"") && plt.Kernel.list([local_dash_symbol_dash_stx,(plt.Kernel.setLastLoc("offset=9093 line=177 span=138 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=9108 line=177 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_defns_plus_pinfo)),(plt.Kernel.setLastLoc("offset=9199 line=178 span=31 id=\"desugar.ss\"")   && stx_dash_loc((plt.Kernel.setLastLoc("offset=9208 line=178 span=21 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=9216 line=178 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))))))),(plt.Kernel.setLastLoc("offset=9278 line=179 span=28 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_body_plus_pinfo))])),(plt.Kernel.setLastLoc("offset=9348 line=180 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=9389 line=181 span=109 id=\"desugar.ss\"")   && pinfo_dash_update_dash_env((plt.Kernel.setLastLoc("offset=9407 line=181 span=29 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_body_plus_pinfo)),(plt.Kernel.setLastLoc("offset=9480 line=182 span=17 id=\"desugar.ss\"")   && pinfo_dash_env(pinfo))))]));
              })());})() :
 ((plt.Kernel.setLastLoc("offset=9562 line=185 span=30 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("begin")))) ?
 ((function() { 
...
begin_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=9641 line=186 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=9648 line=186 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
exprs = (plt.Kernel.setLastLoc("offset=9700 line=187 span=19 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=9706 line=187 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_exprs_plus_pinfo = (plt.Kernel.setLastLoc("offset=9774 line=188 span=33 id=\"desugar.ss\"")   && desugar_dash_expressions(exprs,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=9827 line=189 span=227 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=9833 line=189 span=166 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=9848 line=189 span=97 id=\"desugar.ss\"")   && plt.Kernel.cons(begin_dash_symbol_dash_stx,(plt.Kernel.setLastLoc("offset=9915 line=190 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_exprs_plus_pinfo)))),(plt.Kernel.setLastLoc("offset=9984 line=191 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=10023 line=192 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_exprs_plus_pinfo))]));
              })()) :
 ((plt.Kernel.setLastLoc("offset=10128 line=195 span=29 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("set!")))) ?
 ((function() { 
...
set_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=10204 line=196 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=10211 line=196 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
id = (plt.Kernel.setLastLoc("offset=10260 line=197 span=21 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=10268 line=197 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
value = (plt.Kernel.setLastLoc("offset=10320 line=198 span=20 id=\"desugar.ss\"")   && plt.Kernel.third((plt.Kernel.setLastLoc("offset=10327 line=198 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_value_plus_pinfo = (plt.Kernel.setLastLoc("offset=10395 line=199 span=32 id=\"desugar.ss\"")   && desugar_dash_expression(value,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=10447 line=200 span=272 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=10453 line=200 span=211 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=10468 line=200 span=142 id=\"desugar.ss\"") && plt.Kernel.list([set_dash_symbol_dash_stx,id,(plt.Kernel.setLastLoc("offset=10580 line=202 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_value_plus_pinfo))])),(plt.Kernel.setLastLoc("offset=10649 line=203 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=10688 line=204 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_value_plus_pinfo))]));
              })()) :
 ((plt.Kernel.setLastLoc("offset=10817 line=208 span=27 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("if")))) ?
 ((function() { 
...
if_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=10890 line=209 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=10897 line=209 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
exprs = (plt.Kernel.setLastLoc("offset=10949 line=210 span=19 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=10955 line=210 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_exprs_plus_pinfo = (plt.Kernel.setLastLoc("offset=11023 line=211 span=33 id=\"desugar.ss\"")   && desugar_dash_expressions(exprs,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=11076 line=212 span=224 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=11082 line=212 span=163 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=11097 line=212 span=94 id=\"desugar.ss\"")   && plt.Kernel.cons(if_dash_symbol_dash_stx,(plt.Kernel.setLastLoc("offset=11161 line=213 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_exprs_plus_pinfo)))),(plt.Kernel.setLastLoc("offset=11230 line=214 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=11269 line=215 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_exprs_plus_pinfo))]));
              })()) :
 ((plt.Kernel.setLastLoc("offset=11381 line=219 span=28 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("and")))) ?
 ((function() { 
...
and_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=11456 line=220 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=11463 line=220 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
exprs = (plt.Kernel.setLastLoc("offset=11515 line=221 span=19 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=11521 line=221 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_exprs_plus_pinfo = (plt.Kernel.setLastLoc("offset=11589 line=222 span=33 id=\"desugar.ss\"")   && desugar_dash_expressions(exprs,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=11642 line=223 span=225 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=11648 line=223 span=164 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=11663 line=223 span=95 id=\"desugar.ss\"")   && plt.Kernel.cons(and_dash_symbol_dash_stx,(plt.Kernel.setLastLoc("offset=11728 line=224 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_exprs_plus_pinfo)))),(plt.Kernel.setLastLoc("offset=11797 line=225 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=11836 line=226 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_exprs_plus_pinfo))]));
              })()) :
 ((plt.Kernel.setLastLoc("offset=11932 line=229 span=27 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("or")))) ?
 ((function() { 
...
or_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=12005 line=230 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=12012 line=230 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
exprs = (plt.Kernel.setLastLoc("offset=12064 line=231 span=19 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=12070 line=231 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_exprs_plus_pinfo = (plt.Kernel.setLastLoc("offset=12138 line=232 span=33 id=\"desugar.ss\"")   && desugar_dash_expressions(exprs,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=12191 line=233 span=224 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=12197 line=233 span=163 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=12212 line=233 span=94 id=\"desugar.ss\"")   && plt.Kernel.cons(or_dash_symbol_dash_stx,(plt.Kernel.setLastLoc("offset=12276 line=234 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_exprs_plus_pinfo)))),(plt.Kernel.setLastLoc("offset=12345 line=235 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=12384 line=236 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_exprs_plus_pinfo))]));
              })()) :
 ((plt.Kernel.setLastLoc("offset=12490 line=239 span=31 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("lambda")))) ?
 ((function() { 
...
lambda_dash_symbol_dash_stx = (plt.Kernel.setLastLoc("offset=12571 line=240 span=20 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=12578 line=240 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
args = (plt.Kernel.setLastLoc("offset=12629 line=241 span=21 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=12637 line=241 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
body = (plt.Kernel.setLastLoc("offset=12688 line=242 span=20 id=\"desugar.ss\"")   && plt.Kernel.third((plt.Kernel.setLastLoc("offset=12695 line=242 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr))));
desugared_dash_body_plus_pinfo = (plt.Kernel.setLastLoc("offset=12762 line=243 span=31 id=\"desugar.ss\"")   && desugar_dash_expression(body,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=12813 line=244 span=373 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=12819 line=244 span=215 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=12834 line=244 span=146 id=\"desugar.ss\"") && plt.Kernel.list([lambda_dash_symbol_dash_stx,args,(plt.Kernel.setLastLoc("offset=12951 line=246 span=28 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_body_plus_pinfo))])),(plt.Kernel.setLastLoc("offset=13019 line=247 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=13156 line=249 span=29 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_body_plus_pinfo))]));
              })()) :
 ((plt.Kernel.setLastLoc("offset=13244 line=252 span=22 id=\"desugar.ss\"")   && plt.Kernel.number_question_((plt.Kernel.setLastLoc("offset=13253 line=252 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))) ?
 (plt.Kernel.setLastLoc("offset=13282 line=253 span=17 id=\"desugar.ss\"") && plt.Kernel.list([expr,pinfo])) :
 ((plt.Kernel.setLastLoc("offset=13356 line=256 span=22 id=\"desugar.ss\"")   && plt.Kernel.string_question_((plt.Kernel.setLastLoc("offset=13365 line=256 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))) ?
 (plt.Kernel.setLastLoc("offset=13394 line=257 span=17 id=\"desugar.ss\"") && plt.Kernel.list([expr,pinfo])) :
 ((plt.Kernel.setLastLoc("offset=13477 line=260 span=23 id=\"desugar.ss\"")   && plt.Kernel.boolean_question_((plt.Kernel.setLastLoc("offset=13487 line=260 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))) ?
 (plt.Kernel.setLastLoc("offset=13516 line=261 span=17 id=\"desugar.ss\"") && plt.Kernel.list([expr,pinfo])) :
 ((plt.Kernel.setLastLoc("offset=13593 line=264 span=20 id=\"desugar.ss\"")   && plt.Kernel.char_question_((plt.Kernel.setLastLoc("offset=13600 line=264 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))) ?
 (plt.Kernel.setLastLoc("offset=13629 line=265 span=17 id=\"desugar.ss\"") && plt.Kernel.list([expr,pinfo])) :
 ((plt.Kernel.setLastLoc("offset=13707 line=268 span=22 id=\"desugar.ss\"")   && plt.Kernel.symbol_question_((plt.Kernel.setLastLoc("offset=13716 line=268 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))) ?
 (plt.Kernel.setLastLoc("offset=13745 line=269 span=17 id=\"desugar.ss\"") && plt.Kernel.list([expr,pinfo])) :
 ((plt.Kernel.setLastLoc("offset=13825 line=272 span=30 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(expr,(plt.types.Symbol.makeInstance("quote")))) ?
 (plt.Kernel.setLastLoc("offset=13871 line=273 span=17 id=\"desugar.ss\"") && plt.Kernel.list([expr,pinfo])) :
 ((plt.Kernel.setLastLoc("offset=13976 line=276 span=20 id=\"desugar.ss\"")   && plt.Kernel.pair_question_((plt.Kernel.setLastLoc("offset=13983 line=276 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr)))) ?
 ((function() { 

var exprs; 
var desugared_dash_exprs_plus_pinfo; 
(function (toplevel_dash_expression_dash_show92) { 
exprs = (plt.Kernel.setLastLoc("offset=14034 line=277 span=12 id=\"desugar.ss\"")   && stx_dash_e(expr));
desugared_dash_exprs_plus_pinfo = (plt.Kernel.setLastLoc("offset=14101 line=278 span=33 id=\"desugar.ss\"")   && desugar_dash_expressions(exprs,pinfo)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=14154 line=279 span=159 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=14160 line=279 span=98 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=14175 line=279 span=29 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_exprs_plus_pinfo)),(plt.Kernel.setLastLoc("offset=14243 line=280 span=14 id=\"desugar.ss\"")   && stx_dash_loc(expr)))),(plt.Kernel.setLastLoc("offset=14282 line=281 span=30 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_exprs_plus_pinfo))]));
              })()) :
 (plt.Kernel.setLastLoc("offset=7171 line=138 span=7145 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=7171 line=138 span=7145 id=\\\"desugar.ss\\\"\"")))))))))))))))))))))))); };
var processing_dash_loop = function(a_dash_program, a_dash_pinfo) { return ((plt.Kernel.setLastLoc("offset=14485 line=286 span=18 id=\"desugar.ss\"")   && plt.Kernel.empty_question_(a_dash_program)) ?
 (plt.Kernel.setLastLoc("offset=14519 line=287 span=20 id=\"desugar.ss\"") && plt.Kernel.list([plt.types.Empty.EMPTY,a_dash_pinfo])) :
 (plt.types.Logic.TRUE ?
 ((function() { 
...
desugared_dash_elts_plus_pinfo = (plt.Kernel.setLastLoc("offset=14638 line=290 span=51 id=\"desugar.ss\"")   && desugar_dash_program_dash_element((plt.Kernel.setLastLoc("offset=14663 line=290 span=17 id=\"desugar.ss\"")   && plt.Kernel.first(a_dash_program)),a_dash_pinfo));
desugared_dash_rest_plus_pinfo = (plt.Kernel.setLastLoc("offset=14768 line=292 span=64 id=\"desugar.ss\"")   && processing_dash_loop((plt.Kernel.setLastLoc("offset=14785 line=292 span=16 id=\"desugar.ss\"")   && plt.Kernel.rest(a_dash_program)),(plt.Kernel.setLastLoc("offset=14802 line=292 span=29 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_elts_plus_pinfo)))); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=14852 line=293 span=157 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=14858 line=293 span=97 id=\"desugar.ss\"") && plt.Kernel.append((plt.Kernel.setLastLoc("offset=14866 line=293 span=28 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_elts_plus_pinfo)), [(plt.Kernel.setLastLoc("offset=14926 line=294 span=28 id=\"desugar.ss\"")   && plt.Kernel.first(desugared_dash_rest_plus_pinfo))])),(plt.Kernel.setLastLoc("offset=14979 line=295 span=29 id=\"desugar.ss\"")   && plt.Kernel.second(desugared_dash_rest_plus_pinfo))]));
              })()) :
 (plt.Kernel.setLastLoc("offset=14463 line=285 span=549 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=14463 line=285 span=549 id=\\\"desugar.ss\\\"\"")))))); };
...
return (plt.Kernel.setLastLoc("offset=15024 line=297 span=91 id=\"desugar.ss\"")   && processing_dash_loop((plt.Kernel.setLastLoc("offset=15041 line=297 span=44 id=\"desugar.ss\"")   && reorder_dash_tests_dash_to_dash_end(a_dash_program,plt.types.Empty.EMPTY,plt.types.Empty.EMPTY)),a_dash_pinfo));
              })()); };
var desugar_dash_include = function(include_dash_expr, pinfo) { return ((plt.Kernel.setLastLoc("offset=15237 line=304 span=41 id=\"desugar.ss\"")   && plt.Kernel.not((plt.Kernel.setLastLoc("offset=15242 line=304 span=35 id=\"desugar.ss\"") && plt.Kernel._equal_((plt.Kernel.setLastLoc("offset=15245 line=304 span=29 id=\"desugar.ss\"")   && plt.Kernel.length((plt.Kernel.setLastLoc("offset=15253 line=304 span=20 id=\"desugar.ss\"")   && stx_dash_e(include_dash_expr)))),(plt.types.Rational.makeInstance(2, 1)), [])))) ?
 (plt.Kernel.setLastLoc("offset=15284 line=305 span=106 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("Usage: (include file-path), where file-path is a string.")),include_dash_expr)) :
 ((plt.Kernel.setLastLoc("offset=15397 line=307 span=53 id=\"desugar.ss\"")   && plt.Kernel.not((plt.Kernel.setLastLoc("offset=15402 line=307 span=47 id=\"desugar.ss\"")   && plt.Kernel.string_question_((plt.Kernel.setLastLoc("offset=15411 line=307 span=37 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=15418 line=307 span=29 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=15426 line=307 span=20 id=\"desugar.ss\"")   && stx_dash_e(include_dash_expr)))))))))) ?
 (plt.Kernel.setLastLoc("offset=15456 line=308 span=73 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("file-path must be a string")),(plt.Kernel.setLastLoc("offset=15499 line=308 span=29 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=15507 line=308 span=20 id=\"desugar.ss\"")   && stx_dash_e(include_dash_expr)))))) :
 (plt.types.Logic.TRUE ?
 ((function() { 
...
file_dash_path = (plt.Kernel.setLastLoc("offset=15578 line=311 span=37 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=15585 line=311 span=29 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=15593 line=311 span=20 id=\"desugar.ss\"")   && stx_dash_e(include_dash_expr))))));
stxs = (plt.Kernel.setLastLoc("offset=15643 line=312 span=26 id=\"desugar.ss\"")   && plt.Kernel.openInputStx(file_dash_path)); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=15679 line=313 span=28 id=\"desugar.ss\"")   && desugar_dash_program(stxs,pinfo));
              })()) :
 (plt.Kernel.setLastLoc("offset=15226 line=303 span=484 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=15226 line=303 span=484 id=\\\"desugar.ss\\\"\""))))))); };
...
var x_dash_stx; 
var predicate; 
var loop = function(list_dash_of_dash_datum, answers, datum_dash_last, answer_dash_last) { return ((plt.Kernel.setLastLoc("offset=16912 line=347 span=22 id=\"desugar.ss\"")   && plt.Kernel.empty_question_(list_dash_of_dash_datum)) ?
 (((plt.Kernel.setLastLoc("offset=16954 line=348 span=28 id=\"desugar.ss\"")   && plt.Kernel.symbol_question_((plt.Kernel.setLastLoc("offset=16963 line=348 span=18 id=\"desugar.ss\"")   && stx_dash_e(datum_dash_last))))&&(plt.Kernel.setLastLoc("offset=16983 line=348 span=35 id=\"desugar.ss\"")   && plt.Kernel.symbol_equal__question_((plt.types.Symbol.makeInstance("else")),(plt.Kernel.setLastLoc("offset=16999 line=348 span=18 id=\"desugar.ss\"")   && stx_dash_e(datum_dash_last))))) ?
 answer_dash_last :
 (plt.Kernel.setLastLoc("offset=17060 line=350 span=850 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=17075 line=350 span=787 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17081 line=350 span=37 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("if")),(plt.Kernel.setLastLoc("offset=17100 line=350 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),(plt.Kernel.setLastLoc("offset=17154 line=351 span=494 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=17169 line=351 span=410 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17175 line=351 span=40 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("ormap")),(plt.Kernel.setLastLoc("offset=17197 line=351 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),predicate,(plt.Kernel.setLastLoc("offset=17338 line=353 span=240 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=17353 line=353 span=135 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17359 line=353 span=40 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("quote")),(plt.Kernel.setLastLoc("offset=17381 line=353 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),datum_dash_last])),(plt.Kernel.setLastLoc("offset=17560 line=355 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))))])),(plt.Kernel.setLastLoc("offset=17630 line=356 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),answer_dash_last,(plt.Kernel.setLastLoc("offset=17731 line=358 span=130 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=17746 line=358 span=46 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17752 line=358 span=39 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("void")),(plt.Kernel.setLastLoc("offset=17773 line=358 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))))])),(plt.Kernel.setLastLoc("offset=17843 line=359 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))))])),(plt.Kernel.setLastLoc("offset=17892 line=360 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))))) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=17938 line=362 span=875 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=17953 line=362 span=816 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=17959 line=362 span=37 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("if")),(plt.Kernel.setLastLoc("offset=17978 line=362 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),(plt.Kernel.setLastLoc("offset=18028 line=363 span=485 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=18043 line=363 span=405 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=18049 line=363 span=40 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("ormap")),(plt.Kernel.setLastLoc("offset=18071 line=363 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),predicate,(plt.Kernel.setLastLoc("offset=18204 line=365 span=243 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=18219 line=365 span=142 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=18225 line=365 span=40 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("quote")),(plt.Kernel.setLastLoc("offset=18247 line=365 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),(plt.Kernel.setLastLoc("offset=18339 line=366 span=21 id=\"desugar.ss\"")   && plt.Kernel.first(list_dash_of_dash_datum))])),(plt.Kernel.setLastLoc("offset=18429 line=367 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))))])),(plt.Kernel.setLastLoc("offset=18495 line=368 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),(plt.Kernel.setLastLoc("offset=18545 line=369 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(answers)),(plt.Kernel.setLastLoc("offset=18592 line=370 span=176 id=\"desugar.ss\"")   && loop((plt.Kernel.setLastLoc("offset=18598 line=370 span=20 id=\"desugar.ss\"")   && plt.Kernel.rest(list_dash_of_dash_datum)),(plt.Kernel.setLastLoc("offset=18656 line=371 span=14 id=\"desugar.ss\"")   && plt.Kernel.rest(answers)),datum_dash_last,answer_dash_last))])),(plt.Kernel.setLastLoc("offset=18795 line=374 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))) :
 (plt.Kernel.setLastLoc("offset=16896 line=346 span=1919 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=16896 line=346 span=1919 id=\\\"desugar.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show95) { 
pinfo_plus_val_dash_sym = (plt.Kernel.setLastLoc("offset=16211 line=329 span=25 id=\"desugar.ss\"")   && pinfo_dash_gensym(pinfo,(plt.types.Symbol.makeInstance("val"))));
updated_dash_pinfo_dash_1 = (plt.Kernel.setLastLoc("offset=16267 line=330 span=21 id=\"desugar.ss\"")   && plt.Kernel.first(pinfo_plus_val_dash_sym));
val_dash_stx = (plt.Kernel.setLastLoc("offset=16311 line=331 span=56 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.Kernel.setLastLoc("offset=16326 line=331 span=22 id=\"desugar.ss\"")   && plt.Kernel.second(pinfo_plus_val_dash_sym)),(plt.Kernel.setLastLoc("offset=16349 line=331 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))));
pinfo_plus_x_dash_sym = (plt.Kernel.setLastLoc("offset=16400 line=333 span=33 id=\"desugar.ss\"")   && pinfo_dash_gensym(updated_dash_pinfo_dash_1,(plt.types.Symbol.makeInstance("x"))));
updated_dash_pinfo_dash_2 = (plt.Kernel.setLastLoc("offset=16464 line=334 span=19 id=\"desugar.ss\"")   && plt.Kernel.first(pinfo_plus_x_dash_sym));
x_dash_stx = (plt.Kernel.setLastLoc("offset=16504 line=335 span=54 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.Kernel.setLastLoc("offset=16519 line=335 span=20 id=\"desugar.ss\"")   && plt.Kernel.second(pinfo_plus_x_dash_sym)),(plt.Kernel.setLastLoc("offset=16540 line=335 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))));
predicate = (plt.Kernel.setLastLoc("offset=16624 line=339 span=131 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=16636 line=339 span=81 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("lambda")),(plt.Kernel.setLastLoc("offset=16650 line=339 span=12 id=\"desugar.ss\"") && plt.Kernel.list([x_dash_stx])),(plt.Kernel.setLastLoc("offset=16688 line=340 span=28 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("equal?")),x_dash_stx,val_dash_stx]))])),(plt.Kernel.setLastLoc("offset=16737 line=341 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))));
 })(plt.Kernel.identity)
return ((plt.Kernel.setLastLoc("offset=18835 line=376 span=32 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(an_dash_expr,(plt.types.Symbol.makeInstance("case")))) ?
 (plt.Kernel.setLastLoc("offset=18875 line=377 span=633 id=\"desugar.ss\"")   && deconstruct_dash_clauses_dash_with_dash_else((plt.Kernel.setLastLoc("offset=18906 line=377 span=29 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=18912 line=377 span=22 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=18918 line=377 span=15 id=\"desugar.ss\"")   && stx_dash_e(an_dash_expr)))))),((function() {
   plt.Kernel.setLastLoc("offset=18974 line=378 span=68 id=\"desugar.ss\"");
...
var else_dash_stx = args96[0];
   ...
   plt.Kernel.setLastLoc("offset=19081 line=380 span=426 id=\"desugar.ss\"");
...
var answer_dash_last = args97[3];
                             return (plt.Kernel.setLastLoc("offset=19175 line=381 span=331 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=19181 line=381 span=262 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=19193 line=381 span=173 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("let")),(plt.Kernel.setLastLoc("offset=19204 line=381 span=46 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=19210 line=381 span=39 id=\"desugar.ss\"") && plt.Kernel.list([val_dash_stx,(plt.Kernel.setLastLoc("offset=19224 line=381 span=24 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=19232 line=381 span=15 id=\"desugar.ss\"")   && stx_dash_e(an_dash_expr))))]))])),(plt.Kernel.setLastLoc("offset=19315 line=382 span=50 id=\"desugar.ss\"")   && loop(questions,answers,question_dash_last,answer_dash_last))])),(plt.Kernel.setLastLoc("offset=19425 line=383 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),updated_dash_pinfo_dash_2])); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
 ...
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=19529 line=386 span=92 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.Kernel.setLastLoc("offset=19543 line=386 span=48 id=\"desugar.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("Not a case clause: ~s")), [(plt.Kernel.setLastLoc("offset=19575 line=386 span=15 id=\"desugar.ss\"")   && stx_dash_e(an_dash_expr))])),an_dash_expr)) :
 (plt.Kernel.setLastLoc("offset=18822 line=375 span=801 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=18822 line=375 span=801 id=\\\"desugar.ss\\\"\""))))));
              })()); };
var desugar_dash_cond = function(an_dash_expr, pinfo) { return ((function() { 

var loop = function(questions, answers, question_dash_last, answer_dash_last) { return ((plt.Kernel.setLastLoc("offset=19896 line=398 span=18 id=\"desugar.ss\"")   && plt.Kernel.empty_question_(questions)) ?
 (plt.Kernel.setLastLoc("offset=19925 line=399 span=277 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=19937 line=399 span=224 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("if")),question_dash_last,answer_dash_last,(plt.Kernel.setLastLoc("offset=20030 line=401 span=130 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("error")),(plt.Kernel.list([(plt.types.Symbol.makeInstance("quote")),(plt.types.Symbol.makeInstance("cond"))])),(plt.Kernel.setLastLoc("offset=20084 line=402 span=75 id=\"desugar.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("cond: fell out of cond around ~s")), [(plt.Kernel.setLastLoc("offset=20127 line=402 span=31 id=\"desugar.ss\"")   && Loc_dash__greaterthan_string((plt.Kernel.setLastLoc("offset=20140 line=402 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr))))]))]))])),(plt.Kernel.setLastLoc("offset=20184 line=403 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=20239 line=406 span=406 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=20254 line=406 span=347 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=20260 line=406 span=37 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("if")),(plt.Kernel.setLastLoc("offset=20279 line=406 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))),(plt.Kernel.setLastLoc("offset=20329 line=407 span=17 id=\"desugar.ss\"")   && plt.Kernel.first(questions)),(plt.Kernel.setLastLoc("offset=20378 line=408 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(answers)),(plt.Kernel.setLastLoc("offset=20425 line=409 span=175 id=\"desugar.ss\"")   && loop((plt.Kernel.setLastLoc("offset=20431 line=409 span=16 id=\"desugar.ss\"")   && plt.Kernel.rest(questions)),(plt.Kernel.setLastLoc("offset=20485 line=410 span=14 id=\"desugar.ss\"")   && plt.Kernel.rest(answers)),question_dash_last,answer_dash_last))])),(plt.Kernel.setLastLoc("offset=20627 line=413 span=17 id=\"desugar.ss\"")   && stx_dash_loc(an_dash_expr)))) :
 (plt.Kernel.setLastLoc("offset=19880 line=397 span=767 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=19880 line=397 span=767 id=\\\"desugar.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show98) { 
 })(plt.Kernel.identity)
return ((plt.Kernel.setLastLoc("offset=20667 line=415 span=32 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(an_dash_expr,(plt.types.Symbol.makeInstance("cond")))) ?
 (plt.Kernel.setLastLoc("offset=20707 line=416 span=436 id=\"desugar.ss\"")   && deconstruct_dash_clauses_dash_with_dash_else((plt.Kernel.setLastLoc("offset=20738 line=416 span=22 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=20744 line=416 span=15 id=\"desugar.ss\"")   && stx_dash_e(an_dash_expr)))),((function() {
   plt.Kernel.setLastLoc("offset=20799 line=417 span=100 id=\"desugar.ss\"");
   var result = (function(args99) {
var else_dash_stx = args99[0];
                             return (plt.Kernel.setLastLoc("offset=20858 line=418 span=40 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("true")),(plt.Kernel.setLastLoc("offset=20879 line=418 span=18 id=\"desugar.ss\"")   && stx_dash_loc(else_dash_stx)))); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
   ...
   plt.Kernel.setLastLoc("offset=20938 line=419 span=204 id=\"desugar.ss\"");
...
var answer_dash_last = args100[3];
                             return (plt.Kernel.setLastLoc("offset=21032 line=420 span=109 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=21038 line=420 span=50 id=\"desugar.ss\"")   && loop(questions,answers,question_dash_last,answer_dash_last)),pinfo])); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
 ...
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=21164 line=423 span=92 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.Kernel.setLastLoc("offset=21178 line=423 span=48 id=\"desugar.ss\"") && plt.Kernel.format((plt.types.String.makeInstance("Not a cond clause: ~s")), [(plt.Kernel.setLastLoc("offset=21210 line=423 span=15 id=\"desugar.ss\"")   && stx_dash_e(an_dash_expr))])),an_dash_expr)) :
 (plt.Kernel.setLastLoc("offset=20654 line=414 span=604 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=20654 line=414 span=604 id=\\\"desugar.ss\\\"\""))))));
              })()); };
var deconstruct_dash_clauses_dash_with_dash_else = function(clauses, else_dash_replacement_dash_f, f) { return ((function() { 

var process_dash_clauses = function(clauses, questions_slash_rev, answers_slash_rev) { return ((plt.Kernel.setLastLoc("offset=21729 line=435 span=40 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_((plt.Kernel.setLastLoc("offset=21747 line=435 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)),(plt.types.Symbol.makeInstance("else")))) ?
 ((plt.Kernel.setLastLoc("offset=21784 line=436 span=29 id=\"desugar.ss\"")   && plt.Kernel.not((plt.Kernel.setLastLoc("offset=21789 line=436 span=23 id=\"desugar.ss\"")   && plt.Kernel.empty_question_((plt.Kernel.setLastLoc("offset=21797 line=436 span=14 id=\"desugar.ss\"")   && plt.Kernel.rest(clauses)))))) ?
 (plt.Kernel.setLastLoc("offset=21828 line=437 span=100 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("else clause should be the last, but there's another clause after it")),(plt.Kernel.setLastLoc("offset=21912 line=437 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))) :
 (plt.Kernel.setLastLoc("offset=21943 line=438 span=188 id=\"desugar.ss\"")  && f.apply(null, [[(plt.Kernel.setLastLoc("offset=21946 line=438 span=23 id=\"desugar.ss\"")   && plt.Kernel.reverse(questions_slash_rev)), (plt.Kernel.setLastLoc("offset=21988 line=439 span=21 id=\"desugar.ss\"")   && plt.Kernel.reverse(answers_slash_rev)), (plt.Kernel.setLastLoc("offset=22028 line=440 span=52 id=\"desugar.ss\"")  && else_dash_replacement_dash_f.apply(null, [[(plt.Kernel.setLastLoc("offset=22048 line=440 span=31 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=22055 line=440 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22062 line=440 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses))))))]])), (plt.Kernel.setLastLoc("offset=22098 line=441 span=32 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=22106 line=441 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22113 line=441 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses))))))]]))) :
 ((plt.Kernel.setLastLoc("offset=22154 line=443 span=23 id=\"desugar.ss\"")   && plt.Kernel.empty_question_((plt.Kernel.setLastLoc("offset=22162 line=443 span=14 id=\"desugar.ss\"")   && plt.Kernel.rest(clauses)))) ?
 (plt.Kernel.setLastLoc("offset=22188 line=444 span=154 id=\"desugar.ss\"")  && f.apply(null, [[(plt.Kernel.setLastLoc("offset=22191 line=444 span=23 id=\"desugar.ss\"")   && plt.Kernel.reverse(questions_slash_rev)), (plt.Kernel.setLastLoc("offset=22228 line=445 span=21 id=\"desugar.ss\"")   && plt.Kernel.reverse(answers_slash_rev)), (plt.Kernel.setLastLoc("offset=22264 line=446 span=31 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=22271 line=446 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22278 line=446 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))))), (plt.Kernel.setLastLoc("offset=22309 line=447 span=32 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=22317 line=447 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22324 line=447 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses))))))]])) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=22369 line=449 span=192 id=\"desugar.ss\"")   && process_dash_clauses((plt.Kernel.setLastLoc("offset=22386 line=449 span=14 id=\"desugar.ss\"")   && plt.Kernel.rest(clauses)),(plt.Kernel.setLastLoc("offset=22428 line=450 span=52 id=\"desugar.ss\"")   && plt.Kernel.cons((plt.Kernel.setLastLoc("offset=22434 line=450 span=31 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=22441 line=450 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22448 line=450 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))))),questions_slash_rev)),(plt.Kernel.setLastLoc("offset=22509 line=451 span=51 id=\"desugar.ss\"")   && plt.Kernel.cons((plt.Kernel.setLastLoc("offset=22515 line=451 span=32 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=22523 line=451 span=23 id=\"desugar.ss\"")   && stx_dash_e((plt.Kernel.setLastLoc("offset=22530 line=451 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))))),answers_slash_rev)))) :
 (plt.Kernel.setLastLoc("offset=21713 line=434 span=850 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=21713 line=434 span=850 id=\\\"desugar.ss\\\"\""))))))); };
(function (toplevel_dash_expression_dash_show101) { 
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=22570 line=452 span=37 id=\"desugar.ss\"")   && process_dash_clauses(clauses,plt.types.Empty.EMPTY,plt.types.Empty.EMPTY));
              })()); };
...
clauses_dash_stx = (plt.Kernel.setLastLoc("offset=22819 line=461 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=22827 line=461 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))));
body_dash_stx = (plt.Kernel.setLastLoc("offset=22870 line=462 span=21 id=\"desugar.ss\"")   && plt.Kernel.third((plt.Kernel.setLastLoc("offset=22877 line=462 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))));
ids = (plt.Kernel.setLastLoc("offset=22915 line=463 span=122 id=\"desugar.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=22920 line=463 span=69 id=\"desugar.ss\"");
   var result = (function(args103) {
var clause = args103[0];
                             return (plt.Kernel.setLastLoc("offset=22966 line=464 span=22 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=22973 line=464 span=14 id=\"desugar.ss\"")   && stx_dash_e(clause)))); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
                      return result;
                   })()), [(plt.Kernel.setLastLoc("offset=23017 line=465 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]));
vals = (plt.Kernel.setLastLoc("offset=23062 line=466 span=125 id=\"desugar.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=23067 line=466 span=71 id=\"desugar.ss\"");
   var result = (function(args104) {
var clause = args104[0];
                             return (plt.Kernel.setLastLoc("offset=23114 line=467 span=23 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=23122 line=467 span=14 id=\"desugar.ss\"")   && stx_dash_e(clause)))); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
                      return result;
                   })()), [(plt.Kernel.setLastLoc("offset=23167 line=468 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]));
new_dash_lambda_dash_stx = (plt.Kernel.setLastLoc("offset=23245 line=471 span=216 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=23260 line=471 span=157 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=23266 line=471 span=39 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("lambda")),(plt.Kernel.setLastLoc("offset=23289 line=471 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))),(plt.Kernel.setLastLoc("offset=23339 line=472 span=35 id=\"desugar.ss\"")   && make_dash_stx_colon_list(ids,(plt.Kernel.setLastLoc("offset=23358 line=472 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))),body_dash_stx])),(plt.Kernel.setLastLoc("offset=23445 line=474 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))); })(plt.Kernel.identity)
return (function(){(plt.Kernel.setLastLoc("offset=23485 line=476 span=58 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=23509 line=476 span=27 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=23515 line=476 span=20 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=23521 line=476 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))))),a_dash_stx));
(plt.Kernel.setLastLoc("offset=23550 line=477 span=185 id=\"desugar.ss\"")   && check_dash_duplicate_dash_identifiers_bang_((plt.Kernel.setLastLoc("offset=23580 line=477 span=154 id=\"desugar.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=23585 line=477 span=87 id=\"desugar.ss\"");
   var result = (function(args105) {
var a_dash_clause = args105[0];
                             return (plt.Kernel.setLastLoc("offset=23647 line=478 span=24 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=23654 line=478 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause)))); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
                      return result;
                   })()), [(plt.Kernel.setLastLoc("offset=23714 line=479 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]))));
return (plt.Kernel.setLastLoc("offset=23748 line=480 span=110 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=23754 line=480 span=85 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=23769 line=480 span=26 id=\"desugar.ss\"")   && plt.Kernel.cons(new_dash_lambda_dash_stx,vals)),(plt.Kernel.setLastLoc("offset=23823 line=481 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))),pinfo]));})();
              })()); };
var desugar_dash_let_star_ = function(a_dash_stx, pinfo) { return ((function() { 

var clauses_dash_stx; 
var body_dash_stx; 
var loop = function(clauses) { return ((plt.Kernel.setLastLoc("offset=24214 line=494 span=16 id=\"desugar.ss\"")   && plt.Kernel.empty_question_(clauses)) ?
 body_dash_stx :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=24291 line=497 span=335 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=24306 line=497 span=263 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=24312 line=497 span=46 id=\"desugar.ss\"")   && make_dash_stx_colon_atom((plt.types.Symbol.makeInstance("let")),(plt.Kernel.setLastLoc("offset=24332 line=497 span=25 id=\"desugar.ss\"")   && stx_dash_loc((plt.Kernel.setLastLoc("offset=24341 line=497 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))))),(plt.Kernel.setLastLoc("offset=24395 line=498 span=115 id=\"desugar.ss\"")   && make_dash_stx_colon_list((plt.Kernel.setLastLoc("offset=24410 line=498 span=22 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=24416 line=498 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses))])),(plt.Kernel.setLastLoc("offset=24484 line=499 span=25 id=\"desugar.ss\"")   && stx_dash_loc((plt.Kernel.setLastLoc("offset=24493 line=499 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))))),(plt.Kernel.setLastLoc("offset=24547 line=500 span=21 id=\"desugar.ss\"")   && loop((plt.Kernel.setLastLoc("offset=24553 line=500 span=14 id=\"desugar.ss\"")   && plt.Kernel.rest(clauses))))])),(plt.Kernel.setLastLoc("offset=24600 line=501 span=25 id=\"desugar.ss\"")   && stx_dash_loc((plt.Kernel.setLastLoc("offset=24609 line=501 span=15 id=\"desugar.ss\"")   && plt.Kernel.first(clauses)))))) :
 (plt.Kernel.setLastLoc("offset=24193 line=493 span=435 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=24193 line=493 span=435 id=\\\"desugar.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show106) { 
clauses_dash_stx = (plt.Kernel.setLastLoc("offset=24024 line=488 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=24032 line=488 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))));
body_dash_stx = (plt.Kernel.setLastLoc("offset=24075 line=489 span=21 id=\"desugar.ss\"")   && plt.Kernel.third((plt.Kernel.setLastLoc("offset=24082 line=489 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))));
 })(plt.Kernel.identity)
return (function(){(plt.Kernel.setLastLoc("offset=24652 line=503 span=58 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=24676 line=503 span=27 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=24682 line=503 span=20 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=24688 line=503 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))))),a_dash_stx));
return (plt.Kernel.setLastLoc("offset=24717 line=504 span=51 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=24723 line=504 span=26 id=\"desugar.ss\"")   && loop((plt.Kernel.setLastLoc("offset=24729 line=504 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx)))),pinfo]));})();
              })()); };
...
clauses_dash_stx = (plt.Kernel.setLastLoc("offset=24930 line=511 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=24938 line=511 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))));
body_dash_stx = (plt.Kernel.setLastLoc("offset=24981 line=512 span=21 id=\"desugar.ss\"")   && plt.Kernel.third((plt.Kernel.setLastLoc("offset=24988 line=512 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))));
define_dash_clauses = (plt.Kernel.setLastLoc("offset=25049 line=514 span=306 id=\"desugar.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=25054 line=514 span=263 id=\"desugar.ss\"");
...
name = (plt.Kernel.setLastLoc("offset=25113 line=515 span=24 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=25120 line=515 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause))));
val = (plt.Kernel.setLastLoc("offset=25178 line=516 span=25 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=25186 line=516 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause)))); })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=25227 line=517 span=88 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=25239 line=517 span=23 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("define")),name,val])),(plt.Kernel.setLastLoc("offset=25296 line=518 span=18 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_clause))));
              })()); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
                      return result;
                   })()), [(plt.Kernel.setLastLoc("offset=25335 line=519 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))])); })(plt.Kernel.identity)
return (function(){(plt.Kernel.setLastLoc("offset=25375 line=521 span=58 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=25399 line=521 span=27 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=25405 line=521 span=20 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=25411 line=521 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))))),a_dash_stx));
(plt.Kernel.setLastLoc("offset=25440 line=522 span=142 id=\"desugar.ss\"")   && check_dash_duplicate_dash_identifiers_bang_((plt.Kernel.setLastLoc("offset=25470 line=522 span=111 id=\"desugar.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=25475 line=522 span=44 id=\"desugar.ss\"");
   var result = (function(args110) {
var a_dash_clause = args110[0];
                             return (plt.Kernel.setLastLoc("offset=25494 line=522 span=24 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=25501 line=522 span=16 id=\"desugar.ss\"")   && stx_dash_e(a_dash_clause)))); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
                      return result;
                   })()), [(plt.Kernel.setLastLoc("offset=25561 line=523 span=19 id=\"desugar.ss\"")   && stx_dash_e(clauses_dash_stx))]))));
return (plt.Kernel.setLastLoc("offset=25589 line=524 span=115 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=25595 line=524 span=90 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=25607 line=524 span=37 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("local")),define_dash_clauses,body_dash_stx])),(plt.Kernel.setLastLoc("offset=25669 line=525 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))),pinfo]));})();
              })()); };
var desugar_dash_quasiquote = function(a_dash_stx, pinfo) { return ((function() { 

var handle_dash_quoted = function(a_dash_stx, depth) { return ((plt.Kernel.setLastLoc("offset=25928 line=534 span=17 id=\"desugar.ss\"")   && stx_colon_list_question_(a_dash_stx)) ?
 ((plt.Kernel.setLastLoc("offset=25968 line=535 span=36 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(a_dash_stx,(plt.types.Symbol.makeInstance("quasiquote")))) ?
 (function(){(plt.Kernel.setLastLoc("offset=26059 line=537 span=51 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=26083 line=537 span=20 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=26089 line=537 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))),a_dash_stx));
return ((plt.Kernel.setLastLoc("offset=26168 line=539 span=11 id=\"desugar.ss\"") && plt.Kernel._greaterthan_(depth,(plt.types.Rational.makeInstance(0, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=26207 line=540 span=273 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=26219 line=540 span=205 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=26231 line=540 span=35 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("quote")),(plt.Kernel.setLastLoc("offset=26244 line=540 span=21 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=26251 line=540 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))))])),(plt.Kernel.setLastLoc("offset=26312 line=541 span=111 id=\"desugar.ss\"")   && handle_dash_quoted((plt.Kernel.setLastLoc("offset=26327 line=541 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=26335 line=541 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))),(plt.Kernel.setLastLoc("offset=26410 line=542 span=12 id=\"desugar.ss\"")   && plt.Kernel.add1(depth))))])),(plt.Kernel.setLastLoc("offset=26464 line=543 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=26541 line=545 span=173 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=26553 line=545 span=105 id=\"desugar.ss\"")   && handle_dash_quoted((plt.Kernel.setLastLoc("offset=26568 line=545 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=26576 line=545 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))),(plt.Kernel.setLastLoc("offset=26645 line=546 span=12 id=\"desugar.ss\"")   && plt.Kernel.add1(depth)))),(plt.Kernel.setLastLoc("offset=26698 line=547 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
 (plt.Kernel.setLastLoc("offset=26135 line=538 span=581 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=26135 line=538 span=581 id=\\\"desugar.ss\\\"\""))))));})() :
 ((plt.Kernel.setLastLoc("offset=26763 line=549 span=33 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(a_dash_stx,(plt.types.Symbol.makeInstance("unquote")))) ?
 (function(){(plt.Kernel.setLastLoc("offset=26850 line=551 span=51 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=26874 line=551 span=20 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=26880 line=551 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))),a_dash_stx));
return ((plt.Kernel.setLastLoc("offset=26959 line=553 span=11 id=\"desugar.ss\"") && plt.Kernel._greaterthan_(depth,(plt.types.Rational.makeInstance(1, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=26998 line=554 span=274 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=27010 line=554 span=206 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=27022 line=554 span=35 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("quote")),(plt.Kernel.setLastLoc("offset=27035 line=554 span=21 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=27042 line=554 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))))])),(plt.Kernel.setLastLoc("offset=27103 line=555 span=112 id=\"desugar.ss\"")   && handle_dash_quoted((plt.Kernel.setLastLoc("offset=27118 line=555 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=27126 line=555 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))),(plt.Kernel.setLastLoc("offset=27202 line=556 span=12 id=\"desugar.ss\"")   && plt.Kernel.sub1(depth))))])),(plt.Kernel.setLastLoc("offset=27256 line=557 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
 ((plt.Kernel.setLastLoc("offset=27301 line=558 span=11 id=\"desugar.ss\"") && plt.Kernel._equal_(depth,(plt.types.Rational.makeInstance(1, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=27340 line=559 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=27348 line=559 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=27423 line=561 span=88 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("misuse of a comma or 'unquote, not under a quasiquoting backquote")),a_dash_stx)) :
 (plt.Kernel.setLastLoc("offset=26926 line=552 span=587 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=26926 line=552 span=587 id=\\\"desugar.ss\\\"\"")))))));})() :
 ((plt.Kernel.setLastLoc("offset=27560 line=563 span=42 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(a_dash_stx,(plt.types.Symbol.makeInstance("unquote-splicing")))) ?
 ((plt.Kernel.setLastLoc("offset=27656 line=565 span=11 id=\"desugar.ss\"") && plt.Kernel._greaterthan_(depth,(plt.types.Rational.makeInstance(1, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=27693 line=566 span=268 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=27705 line=566 span=202 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=27717 line=566 span=35 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("quote")),(plt.Kernel.setLastLoc("offset=27730 line=566 span=21 id=\"desugar.ss\"")   && plt.Kernel.first((plt.Kernel.setLastLoc("offset=27737 line=566 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))))])),(plt.Kernel.setLastLoc("offset=27796 line=567 span=110 id=\"desugar.ss\"")   && handle_dash_quoted((plt.Kernel.setLastLoc("offset=27811 line=567 span=22 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=27819 line=567 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx)))),(plt.Kernel.setLastLoc("offset=27893 line=568 span=12 id=\"desugar.ss\"")   && plt.Kernel.sub1(depth))))])),(plt.Kernel.setLastLoc("offset=27945 line=569 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
 ((plt.Kernel.setLastLoc("offset=27988 line=570 span=11 id=\"desugar.ss\"") && plt.Kernel._equal_(depth,(plt.types.Rational.makeInstance(1, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=28025 line=571 span=87 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("misuse of ,@ or unquote-splicing within a quasiquoting backquote")),a_dash_stx)) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=28194 line=574 span=93 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("misuse of a ,@ or unquote-splicing, not under a quasiquoting backquote")),a_dash_stx)) :
 (plt.Kernel.setLastLoc("offset=27625 line=564 span=664 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=27625 line=564 span=664 id=\\\"desugar.ss\\\"\""))))))) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=28362 line=577 span=1761 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=28374 line=577 span=1698 id=\"desugar.ss\"")   && plt.Kernel.cons((plt.types.Symbol.makeInstance("append")),(plt.Kernel.setLastLoc("offset=28429 line=578 span=1642 id=\"desugar.ss\"") && plt.Kernel.map(((function() {
   plt.Kernel.setLastLoc("offset=28542 line=580 span=1473 id=\"desugar.ss\"");
   var result = (function(args112) {
var s = args112[0];
                             return ((plt.Kernel.setLastLoc("offset=28650 line=582 span=32 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(s,(plt.types.Symbol.makeInstance("quasiquote")))) ?
 (plt.Kernel.setLastLoc("offset=28729 line=583 span=36 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=28741 line=583 span=23 id=\"desugar.ss\"")   && handle_dash_quoted(s,depth))])) :
 ((plt.Kernel.setLastLoc("offset=28859 line=585 span=29 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(s,(plt.types.Symbol.makeInstance("unquote")))) ?
 (plt.Kernel.setLastLoc("offset=28935 line=586 span=36 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=28947 line=586 span=23 id=\"desugar.ss\"")   && handle_dash_quoted(s,depth))])) :
 ((plt.Kernel.setLastLoc("offset=29065 line=588 span=38 id=\"desugar.ss\"")   && stx_dash_begins_dash_with_question_(s,(plt.types.Symbol.makeInstance("unquote-splicing")))) ?
 ((plt.Kernel.setLastLoc("offset=29205 line=590 span=11 id=\"desugar.ss\"") && plt.Kernel._greaterthan_(depth,(plt.types.Rational.makeInstance(1, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=29266 line=591 span=36 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=29278 line=591 span=23 id=\"desugar.ss\"")   && handle_dash_quoted(s,depth))])) :
 ((plt.Kernel.setLastLoc("offset=29353 line=592 span=11 id=\"desugar.ss\"") && plt.Kernel._equal_(depth,(plt.types.Rational.makeInstance(1, 1)), [])) ?
 (function(){(plt.Kernel.setLastLoc("offset=29472 line=594 span=43 id=\"desugar.ss\"")   && check_dash_single_dash_body_dash_stx_bang_((plt.Kernel.setLastLoc("offset=29496 line=594 span=16 id=\"desugar.ss\"")   && plt.Kernel.rest((plt.Kernel.setLastLoc("offset=29502 line=594 span=9 id=\"desugar.ss\"")   && stx_dash_e(s)))),s));
return (plt.Kernel.setLastLoc("offset=29567 line=595 span=18 id=\"desugar.ss\"")   && plt.Kernel.second((plt.Kernel.setLastLoc("offset=29575 line=595 span=9 id=\"desugar.ss\"")   && stx_dash_e(s))));})() :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=29691 line=597 span=138 id=\"desugar.ss\"")   && plt.Kernel.syntax_dash_error((plt.types.String.makeInstance("misuse of ,@ or unquote-splicing within a quasiquoting backquote")),a_dash_stx)) :
 (plt.Kernel.setLastLoc("offset=29150 line=589 span=681 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=29150 line=589 span=681 id=\\\"desugar.ss\\\"\""))))))) :
 (plt.types.Logic.TRUE ?
 (plt.Kernel.setLastLoc("offset=29976 line=601 span=36 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("list")),(plt.Kernel.setLastLoc("offset=29988 line=601 span=23 id=\"desugar.ss\"")   && handle_dash_quoted(s,depth))])) :
 (plt.Kernel.setLastLoc("offset=28598 line=581 span=1416 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=28598 line=581 span=1416 id=\\\"desugar.ss\\\"\"")))))))); });
                      result.toWrittenString = function () {
                          return '<function:lambda>';
                      };
                      result.toDisplayedString = result.toWrittenString;
                      return result;
                   })()), [(plt.Kernel.setLastLoc("offset=30057 line=602 span=13 id=\"desugar.ss\"")   && stx_dash_e(a_dash_stx))])))),(plt.Kernel.setLastLoc("offset=30107 line=603 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
 (plt.Kernel.setLastLoc("offset=25961 line=535 span=4164 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=25961 line=535 span=4164 id=\\\"desugar.ss\\\"\"")))))))) :
 (plt.types.Logic.TRUE ?
 ((plt.Kernel.setLastLoc("offset=30186 line=606 span=11 id=\"desugar.ss\"") && plt.Kernel._greaterthan_(depth,(plt.types.Rational.makeInstance(0, 1)), [])) ?
 (plt.Kernel.setLastLoc("offset=30216 line=607 span=48 id=\"desugar.ss\"")   && datum_dash__greaterthan_stx((plt.Kernel.setLastLoc("offset=30228 line=607 span=19 id=\"desugar.ss\"") && plt.Kernel.list([(plt.types.Symbol.makeInstance("quote")),a_dash_stx])),(plt.Kernel.setLastLoc("offset=30248 line=607 span=15 id=\"desugar.ss\"")   && stx_dash_loc(a_dash_stx)))) :
 (plt.types.Logic.TRUE ?
 a_dash_stx :
 (plt.Kernel.setLastLoc("offset=30162 line=605 span=152 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=30162 line=605 span=152 id=\\\"desugar.ss\\\"\"")))))) :
 (plt.Kernel.setLastLoc("offset=25907 line=533 span=4409 id=\"desugar.ss\"")   && plt.Kernel.error((plt.types.Symbol.makeInstance("cond")),(plt.types.String.makeInstance("cond: fell out of cond around \"offset=25907 line=533 span=4409 id=\\\"desugar.ss\\\"\"")))))); };
(function (toplevel_dash_expression_dash_show111) { 
 })(plt.Kernel.identity)
return (plt.Kernel.setLastLoc("offset=30328 line=611 span=47 id=\"desugar.ss\"") && plt.Kernel.list([(plt.Kernel.setLastLoc("offset=30334 line=611 span=23 id=\"desugar.ss\"")   && handle_dash_quoted(a_dash_stx,(plt.types.Rational.makeInstance(0, 1)))),pinfo]));
              })()); };
