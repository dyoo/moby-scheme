...
return ((plt.Kernel.setLastLoc({offset:3461, line:87, span:38, id:"permission.ss"}) && plt.Kernel.string_equal__question_(a_dash_ref,_SHARED[11], [])) ?
 ...
 (plt.Kernel.setLastLoc({offset:4266, line:106, span:77, id:"permission.ss"})   && construct_dash_permission_slash_1(_SHARED[25],a_dash_ref,(plt.types.liftToplevelToFunctionValue(make_dash_permission_colon_universe,(plt.types.String.makeInstance("make-permission:universe")),(plt.types.Rational.makeInstance(1, 1)),(plt.types.Rational.makeInstance(1, 1)))))) :
