...
;(define n7 (make-node (make-info "7" "seven") 7 (list library-tour food-tour) (make-location 41.825721 -71.414776 7)))
;(define n6 (make-node (make-info "6" "six") 6 (list food-tour) (make-location 41.830202 71.402459 7)))
;(define n5 (make-node (make-info "5" "five") 5 (list food-tour) (make-location 41.823910 -71.396210 7)))
;(define n4 (make-node (make-info "4" "four") 4 empty (make-location 41.823419 -71.399422 7)))
;(define n1 (make-node (make-info "1" "one") 1 empty (make-location 41.825227 -71.401168 7)))
;(define n2 (make-node (make-info "2" "two") 2 (list library-tour) (make-location 41.824158 -71.403591 7)))
;(define n3 (make-node (make-info "3" "three") 3 (list food-tour) (make-location 41.825941 -71.402083 7)))
;(define n0 (make-node (make-info "0" "zero") 0 (list library-tour) (make-location 41.823819 -71.399452 7)))
